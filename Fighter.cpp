...
public:
    // default constructor
    Fighter::Fighter() : name("Dana White"), wins(-1), losses(-1), draws(-1), sigStrAcc(-1),
                     sigStrDef(-1), tdAcc(-1), tdDef(-1), height(-1), weight(-1),
                     sigStrPerMin(-1), sigStrAbsPerMin(-1), tdLandedPer15(-1), avgSubAttemptsPer15(-1) {}
